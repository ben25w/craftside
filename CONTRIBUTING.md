...
4. Run `./script/build_and_run.sh --install` when you need a local `/Applications/CraftSide.app`.
5. Avoid committing API keys, local build products, app bundles, or signing material.
